<?php
	...
	$GLOBALS['cfg']['smol_data_dir'] = '/mnt/usb/data/';
	...
	$GLOBALS['cfg']['display_message_text'] = 'site-wide announcement goes here';
	...
	$GLOBALS['cfg']['db_main'] = array(
		'host'	=> 'localhost',
		'name'	=> 'smoldata',       # database name
		'user'	=> 'smoldata',       # database username
		'auto_connect' => 0,
	);
