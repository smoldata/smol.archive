<?php
	...
	function _db_connect($cluster, $shard){
		...
		if ($GLOBALS['db_conns'][$cluster_key]){
			...
			@mysqli_query($GLOBALS['db_conns'][$cluster_key], "SET character_set_results='utf8', character_set_client='utf8', character_set_connection='utf8', character_set_database='utf8', character_set_server='utf8'");
		}
